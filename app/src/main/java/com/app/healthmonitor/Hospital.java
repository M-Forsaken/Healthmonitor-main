...
public class Hospital extends AppCompatActivity {
    ...
    MapView mapView;
    FloatingActionButton focusLocation;

    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        @Override
        public void onActivityResult(Boolean result) {
            if (result){
                Toast.makeText(Hospital.this,"Permission Granted!",Toast.LENGTH_SHORT).show();
            }
            else {
                Toast.makeText(Hospital.this,"Permission not Granted!",Toast.LENGTH_SHORT).show();
            }
        }
    });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapboxMap().loadStyleUri(Style.OUTDOORS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                locationPuck2D.setBearingImage(AppCompatResources.getDrawable(Hospital.this,R.drawable.baseline_location_on_24));
